...
public class BookApiControllerTest {
    ...
    @Sql("classpath:db/tableInit.sql")
    @Test
    public void getBookOne_test() {// 1. getBookOne_test 시작전에 BeforeEach를 시작하는데 ! 이 모든 것 전에 table을 초기화를 한번 함.
        // given
        Long id = 1L;
        // when
    ...
    public void saveBook_test() throws Exception {
        ...
        ResponseEntity<String> response = rt.exchange("/api/v1/book", HttpMethod.POST,
